...
Version 5.3 contains updates to all of the exiting tables through the
end of the 2005 season, including post-season awards.  There have been
no changes to the database design since version 5.1
...
editor for two editions of Total Baseball and has been active in
...
premier online refernce source, Forman's site provides an oustanding
...
databse. Listed alphabetically, they are: Derek Adair, Mike Crain, 
Kevin Johnson, Tom "TangoTiger", and Paul Wendt. These folks did most
of the heavy lifting, and are largely responsible for the improvements
made to the current release.

Others who made important contributions include: Cliffor Blau, 
Bill Burgess, Jeff Burk, Randy Cox, Mitch Dickerman, Paul DuBois,
Mike Emeigh, F.X. Flinn, Bill Hickman, Jerry Hoffman, Dan Holmes, 
Micke Hovmoller, Peter Kreutzer, Danile Levine, Bruce Macleod,
Ken Matinale, Michael Mavrogiannis, Rod Nelson, Cliff Otto, Alberto
Perdomo, Dave Quinn, Tom Ruane, Theron Skyles, Michael Westbay, 
and Rob Wood.
...
A third option is to use the spreadsheet versions, which were a new
feature of the 2004 release. They contain all of the the yearly 
batting, pitching, and fielding stats from 1871-2005 in a usable format
for users without any database application.
...
Sections 2.1 through 2.20 of this document describe each of the tables in
...
yearID         Year
stintID        player's stint (order of appearances within a season)
teamID         Team
lgID           League
G              Games
AB             At Bats
